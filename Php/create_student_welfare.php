        ...
        if ((in_array($fileMimeType, $allowedImageTypes))) {
            ...
            if ($fileSize <= $maxFileSize) {
                ...
                if (move_uploaded_file($profile_pic['tmp_name'], $filePath)) {
                    $stmt = $conn->prepare('INSERT INTO student_welfare (name,profile_pic,position,responsibility,bio,respect) VALUES (?, ?,?,?,?,?)');
    ...
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" name="upload" id="upload">Create Student Welfare</button>
            </form>
            </section>
          </main>
    </div>
