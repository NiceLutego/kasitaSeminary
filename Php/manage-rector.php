<?php
    ...
    if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['remove'])){
      ...
      if(!empty($id)){
        $stmt = $conn ->prepare("DELETE FROM rector WHERE id = ?");
...
<body>
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <form action="../Php/create_rector.php" method="post">
              <button type="submit">Create new Rector</button>
            </form>
