<?php
    ...
    $result = $conn ->query("SELECT * FROM class_teachers");
    ?>
...
<body>
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <h3>Kasita Seminary Class Teachers</h3>
            <table border="1">
              <tr>
                <th>Name</th>
                <th>Class</th>
            ...
            <form action="../Php/create_class_teacher.php" method="post">
              <button type="submit">Create new Class Teacher</button>
            </form>
