<?php
    ...
    if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['remove'])){
      ...
      if(!empty($id)){
        $stmt = $conn ->prepare("DELETE FROM vice_rector WHERE id = ?");
    ...
    $result = $conn ->query("SELECT * FROM vice_rector");
    ?>
...
<body>
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <h3>Kasita Seminary Vice Rector</h3>
            <table border="1">
              <tr>
                <th>Name</th>
            ...
            <form action="../Php/create_vice_rector.php" method="post">
              <button type="submit">Create new Vice Rector</button>
            </form>
