<?php
    ...
    if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['remove'])){
      ...
      if(!empty($id)){
        $stmt = $conn ->prepare("DELETE FROM sports_master WHERE id = ?");
    ...
    $result = $conn ->query("SELECT * FROM sports_master");
    ?>
...
<body>
    <div class="admin-container">
        ...
        <main class="content">
            <header>
                <h1>Sports Masters</h1>
            </header>
            <h3>Kasita Seminary Sports Masters</h3>
            <table border="1">
              <tr>
                <th>Name</th>
            ...
            <form action="../Php/create_sports_master.php" method="post">
