<?php
    ...
    if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['remove'])){
      ...
      if(!empty($id)){
        $stmt = $conn ->prepare("DELETE FROM academic_masters WHERE id = ?");
    ...
    $result = $conn ->query("SELECT * FROM academic_masters");
    ?>
...
<body>
    <div class="admin-container">
        ...
        <main class="content">
            ...
            <h3>Kasita Seminary Academic masters</h3>
            <table border="1">
              <tr>
                <th>Name</th>
            ...
            <form action="../Php/create_academic_master.php" method="post">
              <button type="submit">Create new academic</button>
            </form>
