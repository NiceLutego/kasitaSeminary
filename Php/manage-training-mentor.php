<?php
    ...
    if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['remove'])){
      ...
      if(!empty($id)){
        $stmt = $conn ->prepare("DELETE FROM training_mentor WHERE id = ?");
    ...
    $result = $conn ->query("SELECT * FROM training_mentor");
    ?>
...
<body>
    <div class="admin-container">
        ...
        <main class="content">
            <header>
                <h1>Training Mentors</h1>
            </header>
            <h3>Kasita Seminary Training mentors</h3>
            <table border="1">
              <tr>
                <th>Name</th>
            ...
            <form action="../Php/create_training_mentor.php" method="post">
              <button type="submit">Create new Training Mentor</button>
            </form>
